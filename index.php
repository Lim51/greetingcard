...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=orderHistory">Send Card History</a></li>
  ...
  <footer class="bg-light py-5">
    <div class="container">
      <div class="small text-center text-muted">Copyright © <?= date("Y") ?> - <?= $_SESSION['setting_name'] ?> </div>
    </div>
    <!-- <a href="mailto:limchingyee2@mail.com" target="_blank">limchingyee2@gmail.com</a> -->
  </footer>
  ...
  <?php if (!isset($_SESSION['login_user_id'])) : ?>
    <script>
      $(document).ready(function() {
        if (!<?php echo isset($_SESSION['login_user_id']) ? 'true' : 'false'; ?>) {
          ...
          $('#cat-menu-link').on('click', function(e) {
            e.preventDefault();
            $('#login_now').trigger('click');
          });
