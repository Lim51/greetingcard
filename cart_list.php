 ...
 <header class="masthead">
	...
	<section class="page-section" id="menu">
        <div class="container">
        	...
        	<div class="col-lg-8">
				...
				$total = 0;
				$get = $conn->query("SELECT *,c.id as cid FROM cart c inner join card_list p on p.id = c.card_id ".$data);
		        		...
		        		<div class="row">
			        		...
			        		<div class="col-md-4">
			        			...
			        			<div class="input-group mb-3">
								  ...
								  <button class="btn btn-outline-dark btn-sm" id=""><i class="fa fa-copy"></i> Direct Send </button>
								  <button class="btn btn-outline-dark btn-sm" id=""><i class="fa fa-copy"></i> Customize </button>
								</div>
			        		</div>
		        		</div>
	        		</div>
    ...
    <script>
        ...
        $('.view_prod').click(function(){
            uni_modal_right('Card','view_prod.php?id='+$(this).attr('data-id'))
        })
